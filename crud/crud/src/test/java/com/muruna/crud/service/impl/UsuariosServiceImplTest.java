package com.muruna.crud.service.impl;

import com.muruna.crud.jwt.JwtService;
import com.muruna.crud.model.Phones;
import com.muruna.crud.model.Usuarios;
import com.muruna.crud.repository.PhonesRepository;
import com.muruna.crud.repository.UsuariosRepository;
...
class UsuariosServiceImplTest {
    ...
    void loadUserByUser() {
        ...
        user.setUsername("jperez@bci.com");
